...
const PremiumPrivateBoxIcon = () => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
    ...
    <path d="M21 15C21 15.5304 20.7893 16.0391 20.4142 16.4142C20.0391 16.7893 19.5304 17 19 17H7L3 21V5C3 4.46957 3.21071 3.96086 3.58579 3.58579C3.96086 3.21071 4.46957 3 5 3H19C19.5304 3 20.0391 3.21071 20.4142 3.58579C20.7893 3.96086 21 4.46957 21 5V15Z" stroke="url(#pmIconGrad)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M8 9H16M8 13H12" stroke="url(#pmIconGrad)" strokeWidth="2" strokeLinecap="round"/>
  </svg>
);
const MusicIcon = () => (
                          ...
                          <div className="header-right">
                              ...
                              >
                                  <svg viewBox="0 0 24 24" width="16" height="16" fill="none">
                                      <defs>
                                        <linearGradient id="frIconGrad" x1="0%" y1="0%" x2="100%" y2="100%">
                                          <stop offset="0%" stopColor="#ec4899"/>
                                          <stop offset="100%" stopColor="#8b5cf6"/>
                                        </linearGradient>
                                      </defs>
                                      <path fill="url(#frIconGrad)" d="M15,14C12.33,14 7,15.33 7,18V20H23V18C23,15.33 17.67,14 15,14M6,10V7H4V10H1V12H4V15H6V12H9V10M15,12A4,4 0 0,0 19,8A4,4 0 0,0 15,4A4,4 0 0,0 11,8A4,4 0 0,0 15,12Z"/>
                                  </svg>
