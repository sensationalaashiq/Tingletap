...
const faqData = [
  { question: "What is TingleTap?", answer: "TingleTap is India's premium chat platform featuring live chat rooms, voice messages, YouTube sharing, RJ radio shows, live broadcast, TingleBot AI, virtual gifting, radio channels, emoji reactions, private messaging, and much more — all designed for meaningful real-time connections." },
  { question: "Is TingleTap free to use?", answer: "Yes! TingleTap is completely free with unlimited access to all chat rooms, voice messaging, YouTube sharing, private messages, profile customization, radio features, and TingleBot AI. Virtual coins can be earned or purchased to send gifts to RJs." },
  { question: "What unique features does TingleTap offer?", answer: "Live Chat Rooms with voice & video\nTingleBot AI assistant in chat\nRJ Radio Shows — live voice broadcasts\nYouTube sync for RJ broadcasts\nLive Broadcast Studio (go live yourself)\nVirtual Gifts & Coin wallet\nRadio Channels — multiple live stations\nEmoji Reactions on messages\nVoice messages with waveform player\nGIF & Sticker support\nPrivate encrypted messaging\nFont & theme customization\nGender verification badges\nDevice fingerprinting security" },
  { question: "What is TingleBot?", answer: "TingleBot is TingleTap's built-in AI assistant powered by Google's Gemini AI. You can chat with TingleBot to get answers, jokes, trivia, suggestions, and more — directly inside any chat room. Just type @TingleBot or use the bot button to start a conversation." },
  ...
  { question: "What moderation features exist?", answer: "Advanced moderation includes user reporting, admin controls, TingleBot AutoMod with AI spam detection, ban/kick functions, content filtering, device fingerprinting, IP banning, and 24/7 monitoring to ensure community safety." },
