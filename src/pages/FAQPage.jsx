...
const faqData = [
  { question: "What is TingleTap?", answer: "TingleTap is India's premium chat platform featuring live chat rooms, voice messages, YouTube sharing, RJ radio shows, live broadcast, Broadcast Stage (mini podcast with guest speakers), auto translation, TingleBot AutoMod, virtual gifting, radio channels, emoji reactions, private messaging, and much more — all designed for meaningful real-time connections." },
  { question: "Is TingleTap free to use?", answer: "Yes! TingleTap is completely free with unlimited access to all chat rooms, voice messaging, YouTube sharing, private messages, auto translation, profile customization, radio features, and TingleBot AutoMod protection. Virtual coins can be earned or purchased to send gifts to RJs." },
  { question: "What unique features does TingleTap offer?", answer: "Live Chat Rooms with voice & media\nTingleBot AutoMod — real-time moderation\nRJ Radio Shows — verified RJ live voice broadcasts\nLive Broadcast — one-to-one or one-to-all, password protected\nBroadcast Stage — speak live with RJ (mini podcast)\nAuto Translation — messages translated to your language\nVirtual Gifts & Coin wallet\nRadio Channels — multiple live stations\nEmoji Reactions on messages\nVoice messages with waveform player\nGIF & Sticker support\nPrivate encrypted messaging\nFont & theme customization\nGender verification badges\nDevice fingerprinting security" },
  ...
  { question: "What is Live Broadcast?", answer: "Any user can start their own public broadcast — one-to-one or one-to-all — with optional password protection to control who can listen. Share your voice live with other users in real-time. RJs additionally get YouTube music sync, a song request queue, Broadcast Stage management for guest speakers, and live announcements." },
  { question: "What is Broadcast Stage?", answer: "Broadcast Stage is a mini-podcast feature that lets audience members join an RJ's live show as speakers. You can request to join the stage — if the RJ accepts, your microphone goes live and all listeners can hear both the RJ and you in real-time. The RJ can mute or remove speakers at any time. It's like a live call-in show or podcast panel." },
  { question: "What is Auto Translation?", answer: "Auto Translation instantly translates chat messages into your preferred language. It works in real-time across all chat rooms — so even if someone writes in Hindi, English, Tamil, or any other language, you can read it in your own language without leaving the conversation. You can enable it per-room or globally from settings." },
