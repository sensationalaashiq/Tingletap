...
const sections = [
  ...
  { icon: 'conduct', title: 'User Conduct', text: 'Users must behave respectfully at all times. Harassment, bullying, spam, hate speech, or sharing inappropriate content is strictly prohibited and will result in account suspension or permanent termination. This applies across all features including chat rooms, live broadcasts, RJ radio shows, and private messages.' },
  { icon: 'content', title: 'Content Guidelines', text: 'All content shared on TingleTap must be appropriate for a diverse community. This includes text messages, voice recordings, YouTube links shared in broadcasts, virtual gifts sent during RJ shows, and emoji reactions. Illegal, offensive, or harmful content is strictly prohibited. Users retain ownership of their content but grant TingleTap a license to display it.' },
  { icon: 'service', title: 'Service Availability', text: 'We strive for 99.9% uptime but cannot guarantee uninterrupted service. Live features such as RJ radio broadcasts, radio channels, TingleBot AutoMod, emoji reactions, and voice calls depend on network conditions. Maintenance windows, updates, and unforeseen events may cause temporary unavailability.' },
