...
const sections = [
  ...
  { icon: 'conduct', title: 'User Conduct', text: 'Users must behave respectfully at all times. Harassment, bullying, spam, hate speech, or sharing inappropriate content is strictly prohibited and will result in account suspension or permanent termination. This applies across all features — chat rooms, RJ radio shows, Live Broadcast (one-to-one or one-to-all, password-protected), Broadcast Stage (speaker/mini-podcast), auto translation, virtual gifts, and private messages.' },
  { icon: 'content', title: 'Content Guidelines', text: 'All content shared on TingleTap must be appropriate for a diverse community. This includes text messages, voice recordings, YouTube links shared in broadcasts, virtual gifts during RJ shows, auto-translated messages, Broadcast Stage audio, and emoji reactions. Illegal, offensive, or harmful content is strictly prohibited. Users retain ownership of their content but grant TingleTap a license to display it.' },
  { icon: 'service', title: 'Service Availability', text: 'We strive for 99.9% uptime but cannot guarantee uninterrupted service. Live features — including RJ radio shows, Live Broadcast, Broadcast Stage speaker audio, auto translation, radio channels, TingleBot AutoMod, emoji reactions, and voice calls — depend on network conditions. Maintenance windows, updates, and unforeseen events may cause temporary unavailability.' },
  { icon: 'liability', title: 'Limitation of Liability', text: 'TingleTap is provided "as is" without any warranties, express or implied. We are not liable for any direct, indirect, incidental, or consequential damages arising from your use of our service, including issues with real-time audio features, auto translation accuracy, or broadcast connectivity.' },
  { icon: 'changes', title: 'Changes to Terms', text: 'We may update these terms periodically to reflect changes in our services or legal requirements. Continued use of TingleTap after changes constitutes acceptance of the updated terms. Material changes — such as new features like Broadcast Stage, auto translation, or password-protected broadcasts — will be announced in-app.' },
];
