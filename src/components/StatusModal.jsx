...
const StatusModal = ({ onClose }) => {
  ...
  const statusPresets = [
    {
      icon: <svg viewBox="0 0 24 24" width="15" height="15"><defs><linearGradient id="p0" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#10b981"/><stop offset="100%" stopColor="#059669"/></linearGradient></defs><circle cx="12" cy="12" r="10" fill="url(#p0)" opacity=".2"/><path fill="#059669" d="M12 2a10 10 0 1 0 0 20A10 10 0 0 0 12 2zm1 15h-2v-6h2zm0-8h-2V7h2z"/></svg>,
      text: 'Happy and content', color: '#059669'
    },
    {
      icon: <svg viewBox="0 0 24 24" width="15" height="15"><defs><linearGradient id="p1" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#3b82f6"/><stop offset="100%" stopColor="#1d4ed8"/></linearGradient></defs><rect x="2" y="2" width="20" height="20" rx="5" fill="url(#p1)" opacity=".2"/><path fill="#2563eb" d="M19 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2zm-7 3a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm1 10h-2V11h2z"/></svg>,
      text: 'Working hard', color: '#2563eb'
    },
    {
      icon: <svg viewBox="0 0 24 24" width="15" height="15"><defs><linearGradient id="p2" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#8b5cf6"/><stop offset="100%" stopColor="#7c3aed"/></linearGradient></defs><circle cx="12" cy="12" r="10" fill="url(#p2)" opacity=".2"/><path fill="#7c3aed" d="M12 3v10.55c-.59-.34-1.27-.55-2-.55-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4V7h4V3h-6z"/></svg>,
      text: 'Listening to music', color: '#7c3aed'
    },
    {
      icon: <svg viewBox="0 0 24 24" width="15" height="15"><defs><linearGradient id="p3" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#f59e0b"/><stop offset="100%" stopColor="#d97706"/></linearGradient></defs><rect x="1" y="5" width="22" height="14" rx="3" fill="url(#p3)" opacity=".2"/><path fill="#d97706" d="M21 6H3c-1.1 0-2 .9-2 2v8c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2zm-10 7H8v3H6v-3H3v-2h3V8h2v3h3v2zm4.5 2c-.83 0-1.5-.67-1.5-1.5v-5c0-.83.67-1.5 1.5-1.5s1.5.67 1.5 1.5v5c0 .83-.67 1.5-1.5 1.5zm4 0c-.83 0-1.5-.67-1.5-1.5v-5c0-.83.67-1.5 1.5-1.5s1.5.67 1.5 1.5v5c0 .83-.67 1.5-1.5 1.5z"/></svg>,
      text: 'Gaming time', color: '#d97706'
    },
    {
      icon: <svg viewBox="0 0 24 24" width="15" height="15"><defs><linearGradient id="p4" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#06b6d4"/><stop offset="100%" stopColor="#0891b2"/></linearGradient></defs><circle cx="12" cy="12" r="10" fill="url(#p4)" opacity=".2"/><path fill="#0891b2" d="M9 4H5L3 8h2l1-3h2L7 8h2l1-4zm6 0h-4l-1 4h2l1-3h2l-1 3h2l1-4zm3 5H6l-2 4h2l1-3h10l1 3h2l-2-4zm-1 5H7l-2 3h2l1-2h8l1 2h2l-2-3z"/></svg>,
      text: 'Studying', color: '#0891b2'
    },
    {
      icon: <svg viewBox="0 0 24 24" width="15" height="15"><defs><linearGradient id="p5" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#a78bfa"/><stop offset="100%" stopColor="#7c3aed"/></linearGradient></defs><rect x="2" y="3" width="20" height="18" rx="4" fill="url(#p5)" opacity=".2"/><path fill="#7c3aed" d="M20 3H4c-1.1 0-2 .9-2 2v2h20V5c0-1.1-.9-2-2-2zM2 19c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2v-9H2v9z"/></svg>,
      text: 'Coffee break', color: '#7c3aed'
    },
    {
      icon: <svg viewBox="0 0 24 24" width="15" height="15"><defs><linearGradient id="p6" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#6b7280"/><stop offset="100%" stopColor="#374151"/></linearGradient></defs><circle cx="12" cy="12" r="10" fill="url(#p6)" opacity=".2"/><path fill="#4b5563" d="M12 3c-4.97 0-9 4.03-9 9s4.03 9 9 9 9-4.03 9-9c0-.46-.04-.92-.1-1.36-.98 1.37-2.58 2.26-4.4 2.26-2.98 0-5.4-2.42-5.4-5.4 0-1.81.89-3.42 2.26-4.4C13 3.04 12.46 3 12 3z"/></svg>,
      text: 'Feeling sleepy', color: '#4b5563'
    },
    {
      icon: <svg viewBox="0 0 24 24" width="15" height="15"><defs><linearGradient id="p7" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#ef4444"/><stop offset="100%" stopColor="#dc2626"/></linearGradient></defs><circle cx="12" cy="12" r="10" fill="url(#p7)" opacity=".2"/><path fill="#dc2626" d="M13.5.67s.74 2.65.74 4.8c0 2.06-1.35 3.73-3.41 3.73-2.07 0-3.63-1.67-3.63-3.73l.03-.36C5.21 7.51 4 10.62 4 14c0 4.42 3.58 8 8 8s8-3.58 8-8C20 8.61 17.41 3.8 13.5.67z"/></svg>,
      text: 'On fire today', color: '#dc2626'
    },
    {
      icon: <svg viewBox="0 0 24 24" width="15" height="15"><defs><linearGradient id="p8" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#ec4899"/><stop offset="100%" stopColor="#be185d"/></linearGradient></defs><circle cx="12" cy="12" r="10" fill="url(#p8)" opacity=".2"/><path fill="#db2777" d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/></svg>,
      text: 'Creative flow', color: '#db2777'
    },
    {
      icon: <svg viewBox="0 0 24 24" width="15" height="15"><defs><linearGradient id="p9" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#f97316"/><stop offset="100%" stopColor="#ea580c"/></linearGradient></defs><circle cx="12" cy="12" r="10" fill="url(#p9)" opacity=".2"/><path fill="#ea580c" d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-7 3l1.25 2.75L16 10l-2.75 1.25L12 14l-1.25-2.75L8 10l2.75-1.25L12 6zm-5 9.5 1 2 2 1-2 1-1 2-1-2-2-1 2-1z"/></svg>,
      text: 'Productive mood', color: '#ea580c'
    },
    {
      icon: <svg viewBox="0 0 24 24" width="15" height="15"><defs><linearGradient id="p10" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#64748b"/><stop offset="100%" stopColor="#334155"/></linearGradient></defs><circle cx="12" cy="12" r="10" fill="url(#p10)" opacity=".2"/><path fill="#475569" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zM4 12c0-4.42 3.58-8 8-8 1.85 0 3.55.63 4.9 1.68L5.68 16.9C4.63 15.55 4 13.85 4 12zm8 8c-1.85 0-3.55-.63-4.9-1.68L18.32 7.1C19.37 8.45 20 10.15 20 12c0 4.42-3.58 8-8 8z"/></svg>,
      text: 'Do not disturb', color: '#475569'
    },
    {
      icon: <svg viewBox="0 0 24 24" width="15" height="15"><defs><linearGradient id="p11" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#84cc16"/><stop offset="100%" stopColor="#65a30d"/></linearGradient></defs><circle cx="12" cy="12" r="10" fill="url(#p11)" opacity=".2"/><path fill="#65a30d" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 14.5v-9l6 4.5-6 4.5z"/></svg>,
  ...
  /* ── Animations (SVG icons, no emojis) ── */
  const animations = [
    {
      name: 'None', value: 'none',
      icon: <svg viewBox="0 0 24 24" width="14" height="14"><path fill="currentColor" d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"/></svg>
    },
    {
      name: 'Pulse', value: 'smPulse 2s ease-in-out infinite',
      icon: <svg viewBox="0 0 24 24" width="14" height="14"><path fill="currentColor" d="M3.5 18.5l6-6 4 4L22 6.92M2 12h3l3-6 4 12 3-8 2 2h3"/></svg>
    },
    {
      name: 'Bounce', value: 'smBounce 1s ease-in-out infinite',
      icon: <svg viewBox="0 0 24 24" width="14" height="14"><path fill="currentColor" d="M12 4l-1.41 1.41L16.17 11H4v2h12.17l-5.58 5.59L12 20l8-8z" transform="rotate(-90 12 12)"/></svg>
    },
    {
      name: 'Glow', value: 'smGlow 2s ease-in-out infinite alternate',
      icon: <svg viewBox="0 0 24 24" width="14" height="14"><path fill="currentColor" d="M12 1l2.39 7.26L22 9l-6.5 6.34L17.18 23 12 19.77 6.82 23l1.68-7.66L2 9l7.61-.74z"/></svg>
    },
    {
      name: 'Rainbow', value: 'smRainbow 3s linear infinite',
      icon: <svg viewBox="0 0 24 24" width="14" height="14"><path fill="currentColor" d="M12 4C7.31 4 3.5 7.02 2.29 11.15A6 6 0 0 1 8 14c0-2.21 1.79-4 4-4s4 1.79 4 4a6 6 0 0 1 5.71-2.85C20.5 7.02 16.69 4 12 4zm0-2c5.52 0 10 4.48 10 10h-2c0-4.42-3.58-8-8-8S4 7.58 4 12H2C2 6.48 6.48 2 12 2z"/></svg>
    },
    {
      name: 'Wave', value: 'smWave 2.5s ease-in-out infinite',
      icon: <svg viewBox="0 0 24 24" width="14" height="14"><path fill="currentColor" d="M17 16.99c-1.35 0-2.2-.42-2.95-.8-.65-.33-1.18-.6-2.05-.6-.9 0-1.4.25-2.05.6-.75.38-1.57.8-2.95.8s-2.2-.42-2.95-.8c-.65-.33-1.18-.6-2.05-.6v-1.5c1.35 0 2.2.42 2.95.8.65.33 1.18.6 2.05.6s1.4-.25 2.05-.6c.75-.38 1.57-.8 2.95-.8s2.2.42 2.95.8c.65.33 1.18.6 2.05.6s1.4-.25 2.05-.6c.75-.38 1.57-.8 2.95-.8v1.5c-.9 0-1.4.25-2.05.6-.75.38-1.58.8-2.95.8z"/></svg>
    },
    {
      name: 'Float', value: 'smFloat 3s ease-in-out infinite',
      icon: <svg viewBox="0 0 24 24" width="14" height="14"><path fill="currentColor" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm4 11h-3v3h-2v-3H8v-2h3V8h2v3h3v2z"/></svg>
    },
    {
      name: 'Shake', value: 'smShake 0.6s ease-in-out infinite',
      icon: <svg viewBox="0 0 24 24" width="14" height="14"><path fill="currentColor" d="M11 21h-1l1-7H7.5c-.58 0-.57-.32-.38-.66.19-.34.05-.08.07-.12C8.48 10.94 10.42 7.54 13 3h1l-1 7h3.5c.49 0 .56.33.47.51l-.07.15C12.96 17.55 11 21 11 21z"/></svg>
    },
  ];
  ...
  const premiumStyles = [
    {
      ...
      icon: <svg viewBox="0 0 24 24" width="12" height="12"><path fill="currentColor" d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"/></svg>
    },
    {
    ...
    },
    {
      ...
      icon: <svg viewBox="0 0 24 24" width="12" height="12"><path fill="#38bdf8" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm.5-13H11v6l5.25 3.15.75-1.23-4.5-2.67V7z"/></svg>
    },
    {
      ...
      <div className="sm-card" onClick={e => e.stopPropagation()}>
        ...
        <div className="sm-body">
          ...
          <div className="sm-section-label">
            <svg viewBox="0 0 24 24" width="10" height="10"><path fill="#a78bfa" d="M3.5 18.5l6-6 4 4L22 6.92"/></svg>
            Quick Presets
          </div>
          ...
          <div className="sm-color-row">
            <button className={`sm-color-mode${!gradientEnabled ? ' active' : ''}`} onClick={() => setGradientEnabled(false)}>
              <svg viewBox="0 0 24 24" width="10" height="10"><circle cx="12" cy="12" r="10" fill="currentColor"/></svg>
              Solid
            </button>
            <button className={`sm-color-mode${gradientEnabled ? ' active' : ''}`} onClick={() => setGradientEnabled(true)}>
              <svg viewBox="0 0 24 24" width="10" height="10"><defs><linearGradient id="cgr" x1="0%" x2="100%"><stop offset="0%" stopColor="#6366f1"/><stop offset="100%" stopColor="#f59e0b"/></linearGradient></defs><circle cx="12" cy="12" r="10" fill="url(#cgr)"/></svg>
              Gradient
            </button>
            {!gradientEnabled ? (
          ...
          <div className="sm-preview">
            ...
            <span className="sm-preview-text" style={getPreviewStyles()}>{displayText}</span>
          </div>
        ...
        <div className="sm-actions">
          <button className="sm-btn sm-btn-clear" onClick={handleClearStatus}>
            <svg viewBox="0 0 24 24" width="12" height="12"><path fill="currentColor" d="M19 4h-3.5l-1-1h-5l-1 1H5v2h14M6 19a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V7H6v12z"/></svg>
            Clear
          </button>
          ...
          <button className="sm-btn sm-btn-save" onClick={handleUpdate} disabled={!selectedPreset && !newStatus.trim()}>
            <svg viewBox="0 0 24 24" width="12" height="12"><path fill="white" d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"/></svg>
            Save Status
          </button>
        </div>
