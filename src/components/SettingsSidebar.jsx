...
const SettingsSidebar = ({ 
    ...
    const handleGuestRegisterNow = async () => {
        try {
            if (window.cleanupFirestoreListeners) window.cleanupFirestoreListeners();
            if (window.cleanupHomePageListeners) window.cleanupHomePageListeners();
            ...
            console.error('Guest register redirect error:', error);
            navigate('/signup');
        }
    };
                    ...
                    return (
                        <div className="settings-tab-content">
                            <div style={{display:'flex',flexDirection:'column',alignItems:'center',gap:'14px',padding:'28px 16px',textAlign:'center'}}>
                                ...
                                {/* Register Now CTA */}
                                <button
                                    onClick={handleGuestRegisterNow}
                                    style={{marginTop:'12px',width:'100%',padding:'10px 16px',borderRadius:'10px',border:'none',background:'linear-gradient(135deg,#e0e7ff,#ede9fe)',color:'#4338ca',fontWeight:800,fontSize:'12px',cursor:'pointer',display:'flex',alignItems:'center',justifyContent:'center',gap:'7px',boxShadow:'0 2px 8px rgba(99,102,241,0.2)'}}
                                >
                                    <svg viewBox="0 0 24 24" width="14" height="14" fill="#4338ca"><path d="M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5z"/></svg>
                                    Register Free — Unlock Friends
                                </button>
                            </div>
                        </div>
                    );
                    ...
                    <div className="settings-tab-content">
                            ...
                            {auth.currentUser?.isAnonymous ? (
                                ...
                                <div style={{
                                    ...
                                    <button
                                        ...
                                        style={{marginTop:'12px',width:'100%',padding:'10px 16px',borderRadius:'10px',border:'none',background:'linear-gradient(135deg,#e0e7ff,#ede9fe)',color:'#4338ca',fontWeight:800,fontSize:'12px',cursor:'pointer',display:'flex',alignItems:'center',justifyContent:'center',gap:'7px',boxShadow:'0 2px 8px rgba(99,102,241,0.2)'}}
                                    >
                                        <svg viewBox="0 0 24 24" width="14" height="14" fill="#4338ca"><path d="M15 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm-9-2V7H4v3H1v2h3v3h2v-3h3v-2H6zm9 4c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>
                                        Register Free — Unlock Status
                                    </button>
                        ...
                        <div className="modern-setting-group">
                            ...
                            <div className="modern-management-buttons">
                                ...
                                {auth.currentUser?.isAnonymous && (
                                    <button
                                        className="modern-management-btn"
                                        style={{background:'linear-gradient(135deg,#e0e7ff,#ede9fe)',color:'#4338ca',border:'1.5px solid rgba(99,102,241,0.3)',boxShadow:'0 4px 14px rgba(99,102,241,0.18)',fontWeight:800}}
                                        onClick={handleGuestRegisterNow}
                                    >
                                        <svg viewBox="0 0 24 24" width="16" height="16" fill="#4338ca">
                                            <path d="M15 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm-9-2V7H4v3H1v2h3v3h2v-3h3v-2H6zm9 4c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/>
                                        </svg>
